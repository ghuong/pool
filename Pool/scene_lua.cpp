...
int gr_node_add_texture_cmd(lua_State* L)
{
  ...
  luaL_argcheck(L, texture_file_name
                && std::strlen(texture_file_name) > 0, 2,
                "Texture Image Filename expected");

  self->textureFiles.push_back(std::string(texture_file_name));
